"""
Django settings for Almacen_inventory project.
...
SECRET_KEY = 'django-insecure-can3610jl+c*c1uig8yf()^(0+8sgri3-*-&nw*n1^9*7vcd%_'
...
ROOT_URLCONF = 'Almacen_inventory.urls'
...
WSGI_APPLICATION = 'Almacen_inventory.wsgi.application'
